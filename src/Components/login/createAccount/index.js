        ...
        <div className="create-account-section w-full">
            ...
            <form className="p-9">
                <div className="form flex flex-wrap flex-col">
                    <div className="email mb-3 w-full md:w-3/4">
                        <div>
                    ...
                    <div className="password mb-3 w-full md:w-3/4">
                        <div>
                    ...
                    <div className="password mb-3 w-full md:w-3/4">
                        ...
                        <input className="outline-none focus:ring focus:border-blue-500 border-none rounded p-1 w-1/2" type="password" id="con-password" onChange={handleConfirmPassword} value={confirmPassword} />
                    </div>
                    <div className="">
                        <button onClick={handleSubmit} className="border w-full md:w-1/2 border-slate-900 bg-cyan-700 rounded py-1" type="button">Sign up</button>
                    </div>
                    <div className="">
